...
SECRET_KEY = 'd@nbx(@)6c&nmeiyze%z1x9w=@2i)1^)!16_@(24^r9l%c%ky&'
...
DATABASE_ROUTERS = ['meiduo_mall.utils.db_router.DatabaseMasterSlave']
...
QQ_REDIRECT_URI = 'http://www.meiduo.site:8000/oauth_callback'  # 没法改  因为QQ官方认证已经指定了回调地址
...
EMAIL_ACTIVE_URL = 'http://192.168.85.136/emails/verification/'

# fastdfs图片链接前缀
# FDFS_URL = 'http://image.meiduo.site:8888/'
FDFS_URL = 'http://192.168.85.136:8888/'
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'URL': 'http://192.168.85.136:9200/',  # Elasticsearch服务器ip地址，端口号固定为9200
...
ALIPAY_DEBUG = True
ALIPAY_RETURN_URL = 'http://192.168.85.136/payment/status/'
